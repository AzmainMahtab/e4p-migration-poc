...
- For tests against the real Elite4Print dev database, place the sanitized `.dump` file in `backups/` (this directory is gitignored). See `METHODOLOGY.md` for the restore flow.
